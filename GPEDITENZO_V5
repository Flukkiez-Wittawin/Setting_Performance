...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="AllSetting x FiveM" Height="850" Width="900"
  ...
  <Border CornerRadius="32" BorderBrush="#1200A3FF" BorderThickness="1" Effect="{StaticResource PanelGlow}">
    ...
    <Grid>
      ...
      <Grid Name="HeaderBar" Grid.Row="0" Background="Transparent" Cursor="SizeAll">
        ...
        <TextBlock Text="ALLSETTING X FIVEM" FontSize="12" FontWeight="SemiBold"
        ...
        <StackPanel Orientation="Horizontal" HorizontalAlignment="Right" VerticalAlignment="Center" Margin="0,0,18,0">
          <Button Name="BtnMinimize" Content="−" Width="34" Height="30" FontSize="16" FontWeight="Medium"
                  Foreground="#70FFFFFF" Background="Transparent" BorderBrush="Transparent" Margin="0,0,6,0">
            <Button.Template>
          ...
          <Button Name="BtnClose" Content="✕" Width="34" Height="30" FontSize="12" FontWeight="Medium"
                  Foreground="#70FFFFFF" Background="Transparent" BorderBrush="Transparent">
            <Button.Template>
              <ControlTemplate TargetType="Button">
                <Border x:Name="Bg" Background="Transparent" CornerRadius="6">
                  <ContentPresenter HorizontalAlignment="Center" VerticalAlignment="Center"/>
      ...
      <Grid Grid.Row="1">
        ...
        <Grid Name="ViewLogin" Visibility="Visible" Margin="60">
          ...
          <StackPanel Grid.Row="0" VerticalAlignment="Center" HorizontalAlignment="Center">
            <TextBlock Text="ALLSETTING" FontSize="42" FontWeight="SemiBold" HorizontalAlignment="Center">
            ...
            <TextBlock Text="PERFORMANCE ENGINE v5.0" FontSize="14" FontWeight="Medium" Foreground="#60FFFFFF" HorizontalAlignment="Center" Margin="0,6,0,0"/>
            <Border Height="2" Width="90" CornerRadius="2" Background="#00A3FF" Margin="0,20,0,0" HorizontalAlignment="Center">
              <Border.Effect>
          ...
          <Grid Grid.Row="2" Width="360" Height="48" Margin="0,0,0,18">
          ...
          <Grid Grid.Row="3" Height="48" Margin="0,0,0,0">
        ...
        <Grid Name="ViewStart" Visibility="Collapsed" Margin="20">
          ...
          <StackPanel Grid.Row="0" VerticalAlignment="Center" HorizontalAlignment="Center">
            ...
            <TextBlock Text="PERFORMANCE ENGINE v5.0" FontSize="10" FontWeight="Bold" Foreground="#44FFFFFF" HorizontalAlignment="Center" Margin="0,4,0,0"/>
        ...
        <Grid Name="ViewMain" Visibility="Collapsed" Margin="30,20,30,30">
          <Grid.RowDefinitions>
            <RowDefinition Height="Auto"/>
            <RowDefinition Height="*"/>
            <RowDefinition Height="Auto"/>
          ...
          <StackPanel Grid.Row="0" Margin="0,8,0,20">
            <TextBlock Text="GPEDIT ENZO V5" FontSize="18" FontWeight="SemiBold" Foreground="#00A3FF" HorizontalAlignment="Center">
              <TextBlock.Effect>
                <DropShadowEffect BlurRadius="10" Color="#00A3FF" ShadowDepth="0" Opacity="0.5"/>
              </TextBlock.Effect>
            </TextBlock>
            <TextBlock Text="SELECT OPTIMIZATION MODE" FontSize="10" FontWeight="Medium" Foreground="#70FFFFFF" HorizontalAlignment="Center" Margin="0,6,0,0"/>
          </StackPanel>

          <!-- Mode Selector Grid -->
          <ScrollViewer Grid.Row="1" VerticalScrollBarVisibility="Auto" HorizontalScrollBarVisibility="Disabled" Margin="0,0,0,20" MaxHeight="160">
            <WrapPanel Name="ModeGrid" HorizontalAlignment="Center">
              <!-- Analysis Card -->
              <Border Name="AnalysisCard" Margin="6" Padding="12,10" CornerRadius="18" BorderThickness="1.5" BorderBrush="#00FFA3" Background="#0800FFA3" Cursor="Hand">
                <Border.Effect>
                  <DropShadowEffect BlurRadius="14" Color="#00FFA3" ShadowDepth="0" Opacity="0.5"/>
                </Border.Effect>
                <StackPanel>
                  <TextBlock Text="ANALYSIS" FontSize="12" FontWeight="SemiBold" Foreground="#00FFA3" HorizontalAlignment="Center"/>
                  <TextBlock Text="Auto Detect" FontSize="9" Foreground="#90FFFFFF" HorizontalAlignment="Center" Margin="0,3,0,0"/>
                </StackPanel>
              </Border>
              <!-- Mode 1 -->
              <Border Name="Mode1Card" Margin="6" Padding="12,10" CornerRadius="18" BorderThickness="1" BorderBrush="#2ECC71" Background="#082ECC71" Cursor="Hand">
                <Border.Effect>
                  <DropShadowEffect BlurRadius="10" Color="#2ECC71" ShadowDepth="0" Opacity="0.35"/>
                </Border.Effect>
                <StackPanel>
                  <TextBlock Text="ECO" FontSize="12" FontWeight="SemiBold" Foreground="#2ECC71" HorizontalAlignment="Center"/>
                  <TextBlock Text="Low Power" FontSize="9" Foreground="#90FFFFFF" HorizontalAlignment="Center" Margin="0,3,0,0"/>
                </StackPanel>
              </Border>
              <!-- Mode 2 -->
              <Border Name="Mode2Card" Margin="6" Padding="12,10" CornerRadius="18" BorderThickness="1" BorderBrush="#3498DB" Background="#083498DB" Cursor="Hand">
                <Border.Effect>
                  <DropShadowEffect BlurRadius="10" Color="#3498DB" ShadowDepth="0" Opacity="0.35"/>
                </Border.Effect>
                <StackPanel>
                  <TextBlock Text="BALANCED" FontSize="12" FontWeight="SemiBold" Foreground="#3498DB" HorizontalAlignment="Center"/>
                  <TextBlock Text="Daily Use" FontSize="9" Foreground="#90FFFFFF" HorizontalAlignment="Center" Margin="0,3,0,0"/>
                </StackPanel>
              </Border>
              <!-- Mode 3 -->
              <Border Name="Mode3Card" Margin="6" Padding="12,10" CornerRadius="18" BorderThickness="1" BorderBrush="#9B59B6" Background="#089B59B6" Cursor="Hand">
                <Border.Effect>
                  <DropShadowEffect BlurRadius="10" Color="#9B59B6" ShadowDepth="0" Opacity="0.35"/>
                </Border.Effect>
                <StackPanel>
                  <TextBlock Text="PERFORMANCE" FontSize="12" FontWeight="SemiBold" Foreground="#9B59B6" HorizontalAlignment="Center"/>
                  <TextBlock Text="Gaming" FontSize="9" Foreground="#90FFFFFF" HorizontalAlignment="Center" Margin="0,3,0,0"/>
                </StackPanel>
              </Border>
              <!-- Mode 4 -->
              <Border Name="Mode4Card" Margin="6" Padding="12,10" CornerRadius="18" BorderThickness="1" BorderBrush="#E67E22" Background="#08E67E22" Cursor="Hand">
                <Border.Effect>
                  <DropShadowEffect BlurRadius="10" Color="#E67E22" ShadowDepth="0" Opacity="0.35"/>
                </Border.Effect>
                <StackPanel>
                  <TextBlock Text="HIGH PERF" FontSize="12" FontWeight="SemiBold" Foreground="#E67E22" HorizontalAlignment="Center"/>
                  <TextBlock Text="Competitive" FontSize="9" Foreground="#90FFFFFF" HorizontalAlignment="Center" Margin="0,3,0,0"/>
                </StackPanel>
              </Border>
              <!-- Mode 5 -->
              <Border Name="Mode5Card" Margin="6" Padding="12,10" CornerRadius="18" BorderThickness="1.5" BorderBrush="#00A3FF" Background="#1200A3FF" Cursor="Hand">
                <Border.Effect>
                  <DropShadowEffect BlurRadius="14" Color="#00A3FF" ShadowDepth="0" Opacity="0.5"/>
                </Border.Effect>
                <StackPanel>
                  <TextBlock Text="ULTIMATE" FontSize="12" FontWeight="SemiBold" Foreground="#00A3FF" HorizontalAlignment="Center"/>
                  <TextBlock Text="Recommended" FontSize="9" Foreground="#90FFFFFF" HorizontalAlignment="Center" Margin="0,3,0,0"/>
                </StackPanel>
              </Border>
              <!-- Mode 6 -->
              <Border Name="Mode6Card" Margin="6" Padding="12,10" CornerRadius="18" BorderThickness="1" BorderBrush="#FF6B35" Background="#08FF6B35" Cursor="Hand">
                <Border.Effect>
                  <DropShadowEffect BlurRadius="10" Color="#FF6B35" ShadowDepth="0" Opacity="0.35"/>
                </Border.Effect>
                <StackPanel>
                  <TextBlock Text="EXTREME" FontSize="12" FontWeight="SemiBold" Foreground="#FF6B35" HorizontalAlignment="Center"/>
                  <TextBlock Text="Max Perf" FontSize="9" Foreground="#90FFFFFF" HorizontalAlignment="Center" Margin="0,3,0,0"/>
                </StackPanel>
              </Border>
              <!-- Mode 7 -->
              <Border Name="Mode7Card" Margin="6" Padding="12,10" CornerRadius="18" BorderThickness="1" BorderBrush="#FFD700" Background="#08FFD700" Cursor="Hand">
                <Border.Effect>
                  <DropShadowEffect BlurRadius="10" Color="#FFD700" ShadowDepth="0" Opacity="0.35"/>
                </Border.Effect>
                <StackPanel>
                  <TextBlock Text="GOD MODE" FontSize="12" FontWeight="SemiBold" Foreground="#FFD700" HorizontalAlignment="Center"/>
                  <TextBlock Text="Enthusiast" FontSize="9" Foreground="#90FFFFFF" HorizontalAlignment="Center" Margin="0,3,0,0"/>
                </StackPanel>
              </Border>
              <!-- Mode 8 -->
              <Border Name="Mode8Card" Margin="6" Padding="12,10" CornerRadius="18" BorderThickness="1" BorderBrush="#E74C3C" Background="#08E74C3C" Cursor="Hand">
                <Border.Effect>
                  <DropShadowEffect BlurRadius="10" Color="#E74C3C" ShadowDepth="0" Opacity="0.35"/>
                </Border.Effect>
                <StackPanel>
                  <TextBlock Text="OVERDRIVE" FontSize="12" FontWeight="SemiBold" Foreground="#E74C3C" HorizontalAlignment="Center"/>
                  <TextBlock Text="Push Limits" FontSize="9" Foreground="#90FFFFFF" HorizontalAlignment="Center" Margin="0,3,0,0"/>
                </StackPanel>
              </Border>
              <!-- Mode 9 -->
              <Border Name="Mode9Card" Margin="6" Padding="12,10" CornerRadius="18" BorderThickness="1" BorderBrush="#C0392B" Background="#08C0392B" Cursor="Hand">
                <Border.Effect>
                  <DropShadowEffect BlurRadius="10" Color="#C0392B" ShadowDepth="0" Opacity="0.35"/>
                </Border.Effect>
                <StackPanel>
                  <TextBlock Text="MAXIMUM" FontSize="12" FontWeight="SemiBold" Foreground="#C0392B" HorizontalAlignment="Center"/>
                  <TextBlock Text="Absolute" FontSize="9" Foreground="#90FFFFFF" HorizontalAlignment="Center" Margin="0,3,0,0"/>
                </StackPanel>
              </Border>
              <!-- Mode 10 -->
              <Border Name="Mode10Card" Margin="6" Padding="12,10" CornerRadius="18" BorderThickness="1" BorderBrush="#8E44AD" Background="#088E44AD" Cursor="Hand">
                <Border.Effect>
                  <DropShadowEffect BlurRadius="10" Color="#8E44AD" ShadowDepth="0" Opacity="0.35"/>
                </Border.Effect>
                <StackPanel>
                  <TextBlock Text="INSANE" FontSize="12" FontWeight="SemiBold" Foreground="#8E44AD" HorizontalAlignment="Center"/>
                  <TextBlock Text="Experimental" FontSize="9" Foreground="#90FFFFFF" HorizontalAlignment="Center" Margin="0,3,0,0"/>
                </StackPanel>
              </Border>
            </WrapPanel>
          </ScrollViewer>
          ...
          <!-- Feature Tags -->
          <ScrollViewer Grid.Row="3" VerticalScrollBarVisibility="Hidden" HorizontalScrollBarVisibility="Disabled" Margin="6,0,6,12" MaxHeight="55">
            <WrapPanel Name="FeatureTags" HorizontalAlignment="Center">
              <Border Margin="2" Padding="8,4" CornerRadius="6" Background="#0D0F12" BorderBrush="#2000A3FF" BorderThickness="1">
                <TextBlock Text="Network Stack" FontSize="8" FontWeight="Medium" Foreground="#80D2FF"/>
              </Border>
              <Border Margin="2" Padding="8,4" CornerRadius="6" Background="#0D0F12" BorderBrush="#2000A3FF" BorderThickness="1">
                <TextBlock Text="CPU Unpark" FontSize="8" FontWeight="Medium" Foreground="#80D2FF"/>
              </Border>
              <Border Margin="2" Padding="8,4" CornerRadius="6" Background="#0D0F12" BorderBrush="#2000A3FF" BorderThickness="1">
                <TextBlock Text="MMCSS Game" FontSize="8" FontWeight="Medium" Foreground="#80D2FF"/>
              </Border>
              <Border Margin="2" Padding="8,4" CornerRadius="6" Background="#0D0F12" BorderBrush="#2000A3FF" BorderThickness="1">
                <TextBlock Text="GPU Scheduler" FontSize="8" FontWeight="Medium" Foreground="#80D2FF"/>
              </Border>
              <Border Margin="2" Padding="8,4" CornerRadius="6" Background="#0D0F12" BorderBrush="#2000A3FF" BorderThickness="1">
                <TextBlock Text="Combat Input" FontSize="8" FontWeight="Medium" Foreground="#80D2FF"/>
              </Border>
              <Border Margin="2" Padding="8,4" CornerRadius="6" Background="#0D0F12" BorderBrush="#2000A3FF" BorderThickness="1">
                <TextBlock Text="Hit Register" FontSize="8" FontWeight="Medium" Foreground="#80D2FF"/>
              </Border>
              <Border Margin="2" Padding="8,4" CornerRadius="6" Background="#0D0F12" BorderBrush="#2000A3FF" BorderThickness="1">
                <TextBlock Text="Timer 0.5ms" FontSize="8" FontWeight="Medium" Foreground="#80D2FF"/>
              </Border>
            </WrapPanel>
          </ScrollViewer>

          <Grid Grid.Row="4" Margin="0,12,0,16">
            <Button Name="BtnLaunch" Height="50" Width="380" Cursor="Hand" Background="Transparent" BorderThickness="0">
              <Button.Effect>
                <DropShadowEffect x:Name="BtnGlow" BlurRadius="18" Color="#00A3FF" ShadowDepth="0" Opacity="0.5"/>
              </Button.Effect>
              <Button.Template>
                <ControlTemplate TargetType="Button">
                  <Border x:Name="Bd" CornerRadius="25" BorderThickness="1.5" BorderBrush="#00A3FF">
                    <Border.Background>
                      <LinearGradientBrush StartPoint="0,0" EndPoint="1,0">
                        <GradientStop Color="#00A3FF" Offset="0.0"/>
                        <GradientStop Color="#00E0FF" Offset="1.0"/>
                    ...
                    <TextBlock Name="BtnText" Text="LAUNCH OPTIMIZATION" FontSize="13" FontWeight="SemiBold" Foreground="#FFFFFF" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                  </Border>
                  <ControlTemplate.Triggers>
                    <Trigger Property="IsMouseOver" Value="True">
                      <Setter TargetName="Bd" Property="Effect">
                        <Setter.Value>
                          <DropShadowEffect BlurRadius="24" Color="#00E0FF" ShadowDepth="0" Opacity="0.7"/>
                        </Setter.Value>
                      </Setter>
                    </Trigger>
          ...
          <Grid Grid.Row="5" Margin="0,0,0,12">
            <Button Name="BtnRestore" Height="44" Width="380" Cursor="Hand" Background="Transparent" BorderThickness="0">
              <Button.Effect>
                <DropShadowEffect BlurRadius="14" Color="#FF6B35" ShadowDepth="0" Opacity="0.4"/>
              </Button.Effect>
              <Button.Template>
                <ControlTemplate TargetType="Button">
                  <Border x:Name="Bd" CornerRadius="22" BorderThickness="1" BorderBrush="#FF6B35">
                    <Border.Background>
                    ...
                    <StackPanel Orientation="Horizontal" HorizontalAlignment="Center" VerticalAlignment="Center">
                      <TextBlock Text="↺" FontSize="18" FontWeight="Medium" Foreground="#FF6B35" Margin="0,0,10,0"/>
                      <TextBlock Name="BtnRestoreText" Text="RESTORE DEFAULTS" FontSize="12" FontWeight="Medium" Foreground="#CCFFFFFF" VerticalAlignment="Center"/>
                    </StackPanel>
                  </Border>
                  <ControlTemplate.Triggers>
                    <Trigger Property="IsMouseOver" Value="True">
          ...
          <Grid Grid.Row="5">
            ...
            <TextBlock Grid.Row="0" Text="SYSTEM DIAGNOSTIC LOG" FontSize="9" FontWeight="Medium" Foreground="#50FFFFFF" Margin="5,0,0,6"/>
            <ProgressBar Name="ProgBar" Grid.Row="1" Height="3" IsIndeterminate="True" Visibility="Collapsed" BorderThickness="0" Background="#0D0F12" Margin="5,0,5,8">
              <ProgressBar.Foreground>
                <LinearGradientBrush StartPoint="0,0" EndPoint="1,0">
            ...
            <Border Grid.Row="2" CornerRadius="10" BorderThickness="1" Background="#0D0F12" BorderBrush="#2000A3FF">
              <Border.Effect>
...
$analysisCard.Add_MouseLeftButtonUp({
    ...
    $message = "SYSTEM ANALYSIS RESULTS`n`n"
    $message += "CPU: $($specs.CPU)`n"
    $message += "Cores: $($specs.Cores) | Threads: $($specs.Threads)`n"
    $message += "RAM: $($specs.RAM) GB`n"
    $message += "GPU: $($specs.GPU)`n"
    $message += "VRAM: $($specs.VRAM) GB`n`n"
    $message += "System Score: $($specs.Score)/100`n`n"
    $message += "Recommended Mode: $($specs.RecommendedMode)"
  
    # Show results
    $result = [System.Windows.MessageBox]::Show($message + "`n`nApply recommended mode?", "System Analysis", [System.Windows.MessageBoxButton]::YesNo, [System.Windows.MessageBoxImage]::Information)
  
    if ($result -eq [System.Windows.MessageBoxResult]::Yes) {
      Select-Mode $specs.RecommendedMode
    }
  })
